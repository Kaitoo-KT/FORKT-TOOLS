...
# Logo
logo=f'''
{green}  __| _ \  _ \  |  / __ __|   __ __| _ \   _ \  |      __| 
{blue}  _| (   |   /  . <     |        |  (   | (   | |    \__ \ 
{yellow} _| \___/ _|_\ _|\_\   _|       _| \___/ \___/ ____| ____/ 
{cyan}                           [ @By Kaito ]
'''

# Normal slowly printer
def sprint(sentence, second=0.02):
...
def about():
    os.system("clear")
    sprint(logo, 0.01)
    print(f"{cyan}[ToolName]  {purple} : FORKT TOOLS")
    print(f"{cyan}[Version]   {purple} :[1.4]")
    print(f"{cyan}[Author]    {purple} :[FORKT]")
    print(f"{cyan}[WhatsApp]    {purple} :[https://whatsapp.com/channel/0029VajE1K01Hspoz1jpTN3M]")
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by FORKT TOOLS\n#@SukitooV1\n\n"+filedata)
    os.remove(".temp")
...
def decryptsh():
    ...
    with open(".temp2",'r') as temp_f2, open(out_file,'w') as out_f:
        ...
        out_f.write("# Decrypted by FORKT TOOLS\n#@SukitooV1\n\n"+filedata)
    os.remove(".temp2")
    sprint(f"{success}saved in {out_file}")
    main()
...
def main():
    os.system("clear")
    sprint(logo, 0.01)
    print(f"{green}[1]{yellow} Encrypt{white} Bash")
    print(f"{green}[2]{yellow} Decrypt{white} Bash")
